...
@__app_environment_variables_v_3.7 = internal constant [37 x i8] c"07fed4c7-7ce2-4dc6-b2b6-8956434277a3\00", align 16
...
@__DSOCacheEntry_name.1 = internal constant [16 x i8] c"libsqlcipher.so\00", align 16
...
@__DSOCacheEntry_name.7 = internal constant [18 x i8] c"libe_sqlcipher.so\00", align 16
...
@dso_cache = local_unnamed_addr global [48 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 668108874770241751, ; hash 0x945997b57f758d7, from name: sqlcipher.so
		i8 0, ; ignore
	...
	; 10
	%struct.DSOCacheEntry {
		i64 5208542268847519364, ; hash 0x48487598f4437684, from name: libsqlcipher
		i8 0, ; ignore
		i8* getelementptr inbounds ([16 x i8], [16 x i8]* @__DSOCacheEntry_name.1, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 33
	%struct.DSOCacheEntry {
		i64 11196683642582000922, ; hash 0x9b629c734a86e51a, from name: sqlcipher
		i8 0, ; ignore
		i8* getelementptr inbounds ([16 x i8], [16 x i8]* @__DSOCacheEntry_name.1, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 38
	%struct.DSOCacheEntry {
		i64 14456916282298317055, ; hash 0xc8a148c341f3b8ff, from name: libsqlcipher.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([16 x i8], [16 x i8]* @__DSOCacheEntry_name.1, i32 0, i32 0), ; name
		i8* null; handle
	}, 
