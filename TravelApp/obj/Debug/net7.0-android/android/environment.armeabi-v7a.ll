...
@__app_environment_variables_v_3.7 = internal constant [37 x i8] c"07fed4c7-7ce2-4dc6-b2b6-8956434277a3\00", align 1
...
@__DSOCacheEntry_name.8 = internal constant [16 x i8] c"libsqlcipher.so\00", align 1
...
@dso_cache = local_unnamed_addr global [48 x %struct.DSOCacheEntry] [
	...
	; 10
	%struct.DSOCacheEntry {
		i64 961826535, ; hash 0x39544ee7, from name: sqlcipher.so
		i8 0, ; ignore
	...
	; 15
	%struct.DSOCacheEntry {
		i64 1429294163, ; hash 0x55314c53, from name: libsqlcipher.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([16 x i8], [16 x i8]* @__DSOCacheEntry_name.8, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 25
	%struct.DSOCacheEntry {
		i64 2195878055, ; hash 0x82e270a7, from name: libsqlcipher
		i8 0, ; ignore
		i8* getelementptr inbounds ([16 x i8], [16 x i8]* @__DSOCacheEntry_name.8, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 29
	%struct.DSOCacheEntry {
		i64 2536245128, ; hash 0x972c0788, from name: sqlcipher
		i8 0, ; ignore
		i8* getelementptr inbounds ([16 x i8], [16 x i8]* @__DSOCacheEntry_name.8, i32 0, i32 0), ; name
		i8* null; handle
	}, 
