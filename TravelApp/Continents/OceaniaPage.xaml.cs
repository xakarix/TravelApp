...
public partial class OceaniaPage : ContentPage
{
    ...
    void CreateButtons()
    {
        foreach (Oceania item in Enum.GetValues(typeof(Oceania)))
        {
    ...
    void InfoClicked(Oceania Oceania)
    {

        string nameOfButton = SplitCamelCase(Oceania.ToString());
    ...
    void CounterLabel()
    {
        ...
        Preferences.Set("VisitCountOceania", counter);
    }
    ...
    protected override void OnAppearing()
    {
        ...
        if (Preferences.ContainsKey("VisitCountOceania"))
        {
            counter = Preferences.Get("VisitCountOceania", 0);
        }
        else
        {
            counter = 0;
