...
public partial class EuropePage : ContentPage
{
    ...
    void CreateButtons()
    {
        foreach (Europe item in Enum.GetValues(typeof(Europe)))
        {
    ...
    void InfoClicked(Europe europe)
    {
        
        string nameOfButton = SplitCamelCase(europe.ToString());
    ...
    void CounterLabel()
    {
        ...
        Preferences.Set("VisitCount", counter);
    }
    ...
    protected override void OnAppearing()
    {
        ...
        {
            counter = Preferences.Get("VisitCount", 0);
        }
        else
        {
            counter = 0;
