...
public partial class AsiaPage : ContentPage
{
    ...
    void CreateButtons()
    {
        foreach (Asia item in Enum.GetValues(typeof(Europe)))
        {
    ...
    {
        foreach (Asia item in Enum.GetValues(typeof(Asia)))
        {
            Button countryButton = new Button
            {
    ...
    void InfoClicked(Asia Asia)
    {

        string nameOfButton = SplitCamelCase(Asia.ToString());
    ...
    void CounterLabel()
    {
        ...
        Preferences.Set("VisitCountAsia", counter);
    }
    ...
    protected override void OnAppearing()
    {
        ...
        if (Preferences.ContainsKey("VisitCountAsia"))
        {
            counter = Preferences.Get("VisitCountAsia", 0);
        }
        else
        {
            counter = 0;
