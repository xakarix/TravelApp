...
public partial class AfricaPage : ContentPage
{
    ...
    void AddClicked(Africa item)
    {
        ...
        if (button != null && !clickedButtons.Contains(nameOfButton))
        {
            ...
            Preferences.Set("MojaListaKey", arrayAsString);
    ...
    void CreateButtons()
    {
        foreach (Africa item in Enum.GetValues(typeof(Africa)))
        {
    ...
    void InfoClicked(Africa africa)
    {

        string nameOfButton = SplitCamelCase(africa.ToString());
    ...
    void CounterLabel()
    {
        ...
        Preferences.Set("VisitCountAfrica", counter);
    }
    ...
    protected override void OnAppearing()
    {
        ...
        if (Preferences.ContainsKey("VisitCountAfrica"))
        {
            counter = Preferences.Get("VisitCountAfrica", 0);
        }
        else
        {
            counter = 0;
