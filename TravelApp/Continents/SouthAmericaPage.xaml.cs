...
public partial class SouthAmericaPage : ContentPage
{
    ...
    void AddClicked(SouthAmerica item)
    {
    ...
    void CreateButtons()
    {
        foreach (SouthAmerica item in Enum.GetValues(typeof(SouthAmerica)))
        {
    ...
    void InfoClicked(SouthAmerica SouthAmerica)
    {

        string nameOfButton = SplitCamelCase(SouthAmerica.ToString());
    ...
    void CounterLabel()
    {
        ...
        Preferences.Set("VisitCountSAmerica", counter);
    }
    ...
    protected override void OnAppearing()
    {
        ...
        if (Preferences.ContainsKey("VisitCountSAmerica"))
        {
            counter = Preferences.Get("VisitCountSAmerica", 0);
        }
        else
        {
            counter = 0;
